...
export const HomePage: Component = () =>
  div({ classes: ["p-6"] }, function* () {
    ...
    yield* div(
      { classes: ["mt-6", "p-4", "bg-blue-50", "dark:bg-blue-900", "rounded"] },
      function* () {
        yield* h2({ classes: ["font-semibold", "mb-2"] }, "Features used:");
        yield* ul({ classes: ["list-disc", "list-inside", "space-y-1"] }, function* () {
    ...
    yield* div(
      { classes: ["mt-6", "p-4", "bg-green-50", "dark:bg-green-900", "rounded"] },
      function* () {
        yield* h2({ classes: ["font-semibold", "mb-2"] }, "Plugin Architecture:");
        yield* p(
          { classes: ["text-sm"] },
