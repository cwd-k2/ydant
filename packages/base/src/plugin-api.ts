/**
 * @ydant/base - PluginAPI インターフェース
 *
 * base プラグインが提供する API のインターフェース定義。
 * Module augmentation は global.d.ts で行われる。
 */

import type { Builder, PluginAPI } from "@ydant/core";

// KeyedNode は types.ts から re-export
export type { KeyedNode } from "./types";
...
// KeyedNode を import するために必要（循環参照を避ける）
